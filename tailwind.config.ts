...
// Marcellus for editorial headings, Jost for body/UI.
const config: Config = {
  darkMode: "class",
  content: ["./src/**/*.{ts,tsx}"],
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Motion system primitives — see docs/design-system.md §"Motion". Reserved for use
        // by future component work; not yet applied to any page in this phase.
